...
#include <memory>
#include "../../jeu_akiri_qt/include/Grid.h"
...
QT_MOC_LITERAL(1, 5, 6), // "notify"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 13), // "setCellsState"
QT_MOC_LITERAL(4, 27, 18), // "Matrix<cellState>&"
QT_MOC_LITERAL(5, 46, 10) // "cellsState"

    },
    "Grid\0notify\0\0setCellsState\0"
    "Matrix<cellState>&\0cellsState"
};
...
void Grid::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setCellsState((*reinterpret_cast< Matrix<cellState>(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Grid::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Grid::notify)) {
                *result = 0;
                return;
            }
        }
